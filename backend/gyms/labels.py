...
DEFAULT_LABELS = {
    ...
    "errors.outing_enrollment_not_in_gym": "La inscripción a la salida no pertenece a este gimnasio.",
    "errors.owner_only": "Solo el dueño puede realizar esta acción.",
...
SINKRO_LABELS = {
    ...
    "errors.outing_enrollment_not_in_gym": "La inscripción a la salida no pertenece a este entrenamiento.",
    "errors.owner_only": "Solo el dueño puede realizar esta acción.",
    "errors.owner_only_settings": "Solo el dueño puede modificar la configuración.",
    "errors.owner_only_closed_dates": "Solo el dueño puede gestionar las fechas cerradas.",
    "errors.owner_only_staff": "Solo el dueño puede gestionar el staff.",
