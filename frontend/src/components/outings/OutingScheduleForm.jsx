...
function OutingScheduleForm({
  ...
  return (
    ...
    >
      ...
      <div>
        <label htmlFor="outingschedule-day" className="mb-1 block text-sm font-medium text-text-primary">
          Día
        </label>

        <select
          id="outingschedule-day"
          value={formData.day}
          onChange={(e) =>
      ...
      <div className="flex flex-col gap-4 sm:flex-row">
        <div className="flex-1">
          <label htmlFor="outingschedule-start" className="mb-1 block text-sm font-medium text-text-primary">
            Hora inicio
          </label>

          <input
            id="outingschedule-start"
            type="time"
        ...
        <div className="flex-1">
          <label htmlFor="outingschedule-end" className="mb-1 block text-sm font-medium text-text-primary">
            Hora fin
          </label>

          <input
            id="outingschedule-end"
            type="time"
      ...
      <div>
        <label htmlFor="outingschedule-capacity" className="mb-1 block text-sm font-medium text-text-primary">
          Cupo
        </label>

        <input
          id="outingschedule-capacity"
          type="number"
          min="1"
          placeholder="Ej: 15"
        ...
        <p className="mt-1 text-xs text-text-secondary">
          Cantidad máxima de inscriptos por encuentro
        </p>
      </div>
...
export default OutingScheduleForm;